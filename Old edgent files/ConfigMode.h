...
void enterConnectNet() 
 {BlynkState::set(MODE_CONNECTING_NET);
  ...
  Serial.println("i am in connecting net mode");
  ...
  if (WiFi.status() == WL_CONNECTED) 
     ...
     {config_set_last_error(BLYNK_PROV_ERR_NETWORK);
      // BlynkState::set(MODE_ERROR);}}
      BlynkState::set(MODE_CONNECTING_NET);}} // Saad's addition
...
void enterConnectCloud() 
 {BlynkState::set(MODE_CONNECTING_CLOUD);
  ...
  Serial.println("i am in connecting cloud mode1");
  
  Blynk.connect(0);

  Serial.println("i am in connecting cloud mode2");
  ...
  while ((timeoutMs > millis()) && (!Blynk.isTokenInvalid()) && (Blynk.connected() == false))
         {delay(10);
          app_loop();
          Serial.println("i am in connecting cloud mode while loop 1");
          Blynk.run();
          Serial.println("i am in connecting cloud mode while loop 2");
  ...
  if (Blynk.isTokenInvalid()) 
     ...
     {config_set_last_error(BLYNK_PROV_ERR_CLOUD);
      // BlynkState::set(MODE_ERROR);}}
      BlynkState::set(MODE_CONNECTING_CLOUD);}} // Saad's addition
 ...
 {BlynkState::set(MODE_ERROR);
  ...
  while (timeoutMs > millis() || g_buttonPressed)
        {delay(10);
         ...
         Serial.println("i am in error mode");
